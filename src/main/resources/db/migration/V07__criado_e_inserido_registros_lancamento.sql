...
CREATE TABLE lancamento (
                            codigo integer NOT NULL DEFAULT nextval('lancamento_codigo_seq'::regclass),
                            ...
                            CONSTRAINT fk_codigo_categoria FOREIGN KEY (codigo_categoria)
                                REFERENCES categoria(codigo),
                            CONSTRAINT fk_codigo_pessoa FOREIGN KEY (codigo_pessoa)
